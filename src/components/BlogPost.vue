<template>
  <v-card class="mx-auto" max-width="800">
    <v-img src="https://i.redd.it/ew9ytxdesht01.jpg" height="200px"></v-img>

    <v-card-title> Ales in Dun Morogh </v-card-title>

    <v-card-subtitle> An ale guide by the Anvilguard</v-card-subtitle>
